  ...
  return (
    ...
    <div className="container">
      <div className="content">
        <h2 onClick={() => toggleParagraph('innovative')}>About Our Innovative Tech Company {paragraphVisibility.innovative ? "—" : "+"}</h2>
        {paragraphVisibility.innovative && <p>At the forefront of technological advancement in Europe since its inception in 2016, SLTeach has been redefining the landscape of innovation and digital transformation. With a profound commitment to excellence and a relentless pursuit of groundbreaking solutions, we have solidified our position as a leader in the tech industry.</p>}

        <h2 onClick={() => toggleParagraph('journey')}>Our Journey {paragraphVisibility.journey ? "—" : "+"}</h2>
        ...
        <h2 onClick={() => toggleParagraph('pioneers')}>European Pioneers {paragraphVisibility.pioneers ? "—" : "+"}</h2>
        ...
        <h2 onClick={() => toggleParagraph('innovation')}>Innovation {paragraphVisibility.innovation ? "—" : "+"}</h2>
        ...
        <h2 onClick={() => toggleParagraph('clientCentric')}>Client-Centric Approach {paragraphVisibility.clientCentric ? "—" : "+"}</h2>
        ...
        <h2 onClick={() => toggleParagraph('futureForward')}>A Future-Forward Horizon {paragraphVisibility.futureForward ? "—" : "+"}</h2>
        ...
        <h2 onClick={() => toggleParagraph('conclusion')}>In Conclusion {paragraphVisibility.conclusion ?  "—" : "+"}</h2>
